...
import 'package:ashtavakra_gita/textReading.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(primaryColor: Color.fromRGBO(167, 154, 10, 1.0)),
      home: MyHomePage(),
    );
  }
}
...
class MyHomePageState extends State<MyHomePage> {
            ...
            child: ListView(
              ...
              children: [
                Stack(
                  children: [
                    Container(
                      color: Color.fromRGBO(167, 154, 10, 1.0),
                ...
                ListTile(
                  ...
                  onTap: () async {
                    Navigator.pop(cntxt);
                    Share.share(
                        'Hey! Checkout this App.\nAshtavakra Gita in three languages.\n\n'
                        'https://play.google.com/store/apps/details?id=com.bss.ashtavakra_gita',
                        subject: 'Ashtavakra Gita');
                  },
                ),
                Padding(
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      systemNavigationBarColor: Color.fromRGBO(167, 154, 10, 1.0), // navigation bar color
      statusBarColor: Color.fromRGBO(167, 154, 10, 1.0), // status bar color
    ));
    return Scaffold(
        backgroundColor: Global.canvasColor(),
        appBar: AppBar(
          backgroundColor: Color.fromRGBO(167, 154, 10, 1.0),foregroundColor: Color.fromRGBO(167, 154, 10, 1.0),
          leading: TextButton(
              onPressed: () {
                menuDialog(context);
              },
